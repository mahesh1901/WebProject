        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                <div class="col-lg-3 mb-3">
                    <div class="service-item rounded p-6 mb-4">
                        <i class="fa fa-3x fa-laptop-code text-primary mb-4"></i>
                        <h4 class="text-uppercase mb-4">Java <span class="d-block text-body">Developer</span></h4>
                        <p class="m-0">A Java Developer is a programmer who designs, develops, and manages Java-based applications and software.</p>
                    </div>
                </div>
                <div class="col-lg-3 mb-3">
                    <div class="service-item rounded p-6 mb-5">
                        ...
                        <p class="m-0">Web design is not just about creating pretty layouts. It's about understanding the marketing challenge behind your business.</p>
                    </div>
                </div>
                <div class="col-lg-3 mb-2">
                    <div class="service-item rounded p-6 mb-7">
                        ...
                        <p class="m-0">A Python Web Developer is responsible for writing server-side web application logic. Python web developers usually develop back-end components, connect the application with the other</p>
                    </div>
                </div>
                <div class="col-lg-3 mb-2">
                    <div class="service-item rounded p-6 mb-7">
                        ...
                        <p class="m-0">Software testing is the act of examining the artifacts and the behavior of the software under test by validation and verification</p>
                    </div>
                </div>
            </div>
        </div>
