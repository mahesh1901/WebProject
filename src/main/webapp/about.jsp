        ...
        <div class="container pt-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <h5 class="text-uppercase text-primary mb-3">Information Technology courses are an excellent choice to help advance your career.</h5>
                    <p class="mb-4"> Whether you are seeking professional development, new skills, or a new career, information technology courses can help you become a more competitive and valuable employee with important skills. </p>
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light rounded mb-4 px-5" style="height: 150px;">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">WebCoreStone@123gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">
